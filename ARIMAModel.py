...
def draw_acf_pacf(ts,lags):
    ...
    plt.title('Autocorrelation', fontsize=15, weight='bold')
...
plt.subplot(3, 1, 2)
plt.subplots_adjust(hspace=0.5)
seasonal.plot(color='orange', fontsize=15, linewidth=2)
plt.subplots_adjust(hspace=0.5)
plt.title('The Periodicity of Data', fontsize=15, weight='bold')
plt.xticks(fontsize=12)
plt.yticks(fontsize=12)
plt.xlabel('Date', fontsize=15, weight='bold')
plt.ylabel('Count(Million)', fontsize=15, weight='bold')
plt.subplot(3, 1, 3)
plt.subplots_adjust(hspace=0.5)
residual.plot(fontsize=15, linewidth=2)
plt.title('The Residual of Data', fontsize=15, weight='bold')
plt.xticks(fontsize=12)
plt.yticks(fontsize=12)
plt.xlabel('Date', fontsize=15, weight='bold')
plt.ylabel('Count(Million)', fontsize=15, weight='bold')
...
plt.figure(figsize=(8, 8))
residual.plot(label='Residual', linewidth=2)
rollMeanRes.plot(label='Rolling Mean', linewidth=2)
rollStdRes.plot(label='Rolling Standard Deviation', linewidth=2)
plt.title('Rolling Mean & Standard Deviation', fontsize=15, weight='bold')
plt.yticks(fontsize=12)
plt.xticks(fontsize=12)
plt.xlabel('Date', fontsize=15, weight='bold')
...
plt.figure(figsize=(8, 8))
plt.plot(timeData, linewidth=2)
plt.plot(predict, linewidth=2)
plt.legend(['Actual', 'ARIMA'], fontsize=15)
plt.title('The Actual Values and the Expected Values', fontsize=15, weight='bold')
plt.xlabel('Date', fontsize=15, weight='bold')
plt.ylabel('Count(Million)', fontsize=15, weight='bold')
plt.xticks(fontsize=12)
plt.yticks(fontsize=12)
...
plt.figure(figsize=(8, 8))
plt.plot(tem, marker='o', linewidth=3)
plt.title('Pridicted Value Based on ARIMA', fontsize=15, weight='bold')
